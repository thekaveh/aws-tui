# Glue and Athena interaction polish design
...
## 3. Visual and interaction model

### 3.1. Shared bordered selector field
...
## 4. Focus and command behavior

### 4.1. Explicit focus rings
...
## 6. Glue-to-Athena table transfer
...
### 6.2. Typed application clipboard
...
## 7. VMx abstraction-selection standard

### 7.1. Mandatory selection process
...
#### 7.3.1. `vmx31-glue-athena-focus-rings`
...
#### 7.3.3. `vmx31-glue-athena-focus-rings-review-fix`
...
### 7.4. Final responsibility ledger
