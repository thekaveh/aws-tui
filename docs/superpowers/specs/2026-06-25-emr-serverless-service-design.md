...
### Three resource levels, reachable in two taps max
...
### Auto-refresh strategy (range-GET, not re-download)
...
### State indicators (log pane bottom strip)
...
### Reusable hooks for CloudWatch Logs
...
### Application lifecycle (top strip)
...
#### PR-B — Log surface + cancel + lifecycle (~3 days, ~1.5k LOC)
