...
## 3. Task 0: Bootstrap — verify clean baseline before touching anything
...
## 4. Task 1: Fix `ModalButton` label spill (auto-width + min-width)
...
## 5. Task 2: ConfirmModal — path-chip nowrap + danger right-shift
...
## 6. Task 3: ThemePickerModal CSS in all 10 themes (no behavior change yet)
...
## 7. Task 4: ThemePickerVM `preview_command` + Esc rollback wiring
...
## 8. Task 5: ServicesMenu + ServicesHamburger cross-theme audit
...
## 9. Task 6: TransferVM rolling speed window
...
## 10. Task 6.5: `TransfersVM.register_vm` for pre-built TransferVMs
...
## 11. Task 7: TransfersOverlay card redesign (custom bar, meta row, themed)
...
## 12. Task 8: ToastStack polish (per-theme borders + level colors)
...
## 13. Task 9: CHANGELOG + final verification
...
## 15. Self-review notes (for the writing-plans skill record)
