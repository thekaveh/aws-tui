...
### 2.1. Task 1: Reconcile `KeymapStore.DEFAULT_BINDINGS`
...
### 2.2. Task 2: Resolver — skip-unregistered, dispatch action, priority/show metadata
...
### 2.3. Task 3: Wire the App — register handlers, dispatch, install bindings, drop ClassVar
