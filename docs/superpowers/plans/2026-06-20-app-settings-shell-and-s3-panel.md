...
## 5. Task 1: `ConfigStore.update_connection` + `remove_connection`
...
## 6. Task 2: `ConnectionListChangedMessage`
...
## 9. Task 5: `S3CompatFormModal`: `name_locked` + live validation
...
## 10. Task 6: `S3ConnectionsPanel` + `_PlaceholderPanel`
...
## 11. Task 7: `SettingsModal` screen
...
## 12. Task 8: `ServicesMenuFooter` + `ServicesMenu` integration
...
## 13. Task 9: `AwsTuiApp` wiring (+ `AppContext` + `build_app_context`)
...
## 14. Task 10: `ServicesMenuVM` subscription
...
## 15. Task 11: Per-theme CSS × 10 themes
...
## 16. Task 12: Snapshot tests — `SettingsModal` + `ServicesMenuFooter`
...
## 17. Task 13: Snapshot tests — `S3CompatFormModal` edit + validation
...
## 18. Task 14: In-process integration tests
...
## 20. Self-Review Notes (recorded after writing)
