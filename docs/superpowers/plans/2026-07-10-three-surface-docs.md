...
## 3. Task 1: Scaffolding, gitignore, and uv docs dependency group
...
## 4. Task 2: `manifest.py` — parse and validate `manifest.yaml`
...
## 5. Task 3: `links.py` — link discovery + the 3×3 forbidden matrix
...
## 6. Task 4: `transforms.py` — source map + per-surface link rewriting
...
## 7. Task 5: `render_diagrams.py` — HTML master → SVG + PNG
...
## 8. Task 6: `build_docs.py` — render site, wiki, mkdocs.yml + determinism
...
## 9. Task 7: `check_docs.py` — the CI gate
...
## 10. Task 8: `push_wiki.py` — sync `generated/wiki/` → `aws-tui.wiki.git`
...
## 11. Task 9: Canonical content — index, manifest, theme assets, architecture diagram
...
## 12. Task 10: `Makefile` — docs targets (uv-native)
...
## 13. Task 11: CI workflows — `docs.yml` (gate) + `pages.yml` (publish)
...
## 14. Task 12: Full integration — green end-to-end locally
...
## 15. Task 13: Phase 2 runbook — external/publish steps (GATED; not run during build)
...
## 16. Self-Review (completed against the spec)
