...
## 1. Task 1: Crash modal + unhandled-exception capture
...
## 2. Task 2: Transfer journal resume modal
...
## 5. Task 5: CHANGELOG, version bump, commit, tag v0.7.0
