...
### 1.1. Task 1: Detect Table Formats and Define Iceberg Metadata Records
...
### 1.2. Task 2: Extract a Bounded Athena Runner and Implement IcebergInspector
...
### 1.3. Task 3: Add Connection-Preserving Glue and Athena Cross-Navigation
...
### 1.4. Task 4: Add Iceberg Metadata ViewModels and Glue UI
...
### 1.5. Task 5: Complete Integrated Demo and End-to-End Journeys
...
### 1.6. Task 6: Synchronize Documentation, Diagram, Contracts, and Release Checks
