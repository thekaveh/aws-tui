...
### 1.1. Task 1: Add the Shared Service Source Context
...
### 1.2. Task 2: Make Connection and Service Switching Atomic in RootVM
...
### 1.3. Task 3: Route Service Widgets Through One View Factory
...
### 1.4. Task 4: Make Shift+S Cycle Single-Context AWS Connections
...
### 1.5. Task 5: Separate EMR Application Cycling From Source Switching
...
### 1.6. Task 6: Render the EMR Source Header and Complete Foundation Verification
