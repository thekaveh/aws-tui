...
## 3. Task 1: Build the shared underline tab rail and remove legacy theme rules
...
## 4. Task 2: Replace Glue's context pane with an unframed control row
...
## 5. Task 3: Prove focused, unfocused, open-picker, and responsive visual states
...
## 6. Task 4: Synchronize canonical docs and run the complete verification gate
