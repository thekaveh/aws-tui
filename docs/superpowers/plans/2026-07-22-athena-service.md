...
### 1.1. Task 1: Add Query Models and Fail-Closed SQL Validation
...
### 1.2. Task 2: Implement the Paginated Athena Domain Client
...
### 1.3. Task 3: Build Query and Result ViewModels
...
### 1.4. Task 4: Build History, Saved, and Page ViewModels
...
### 1.5. Task 5: Build and Register the Athena Textual Service
...
### 1.6. Task 6: Add Multi-Profile Athena Demo Data and S3 Result Handoff
...
### 1.7. Task 7: Document and Verify Standalone Athena Support
