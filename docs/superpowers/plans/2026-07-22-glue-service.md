...
### 1.1. Task 1: Define Shared Catalog Domain Models
...
### 1.2. Task 2: Implement the Paginated Glue Domain Client
...
### 1.3. Task 3: Build Glue Catalog, Jobs, and Crawlers ViewModels
...
### 1.4. Task 4: Build the Glue Textual Page
...
### 1.5. Task 5: Register Glue and Add Multi-Profile Demo Data
...
### 1.6. Task 6: Add Glue-to-S3 Handoff, Documentation, and Full Verification
