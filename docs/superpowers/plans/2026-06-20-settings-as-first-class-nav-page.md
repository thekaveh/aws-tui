...
### 2.3. Files to delete (in Task 11)
...
## 5. Task 2: Rename `ServicesMenuVM` → `NavMenuVM` + add Settings item
...
## 6. Task 3: `ConnectionFormInline` widget
...
## 7. Task 4: `NavMenu` widget (OptionList-based)
...
## 9. Task 6: `S3ConnectionsPanel` switches to `ConnectionFormInline`
...
## 10. Task 7: Per-theme CSS for new widgets (×10 themes)
...
## 11. Task 8: Snapshot tests for new widgets + content-presence guards
...
## 12. Task 9: Wire `AwsTuiApp` + `composition.py`
...
## 13. Task 10: New integration test
...
## 14. Task 11: Migrate `FirstRunModal`; delete obsolete files
...
## 15. Task 12: Rewrite the CHANGELOG entry
