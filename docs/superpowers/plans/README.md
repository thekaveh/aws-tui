...
22. [Overlay pickers, one-line commands, and Athena handoffs](2026-08-24-overlay-pickers-command-handoffs.md) — stable overlay selectors, compact tooltip-rich commands, and unified Glue-to-Athena table/snapshot actions.
