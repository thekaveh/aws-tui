...
## 1. Task 1: VMx familiarization spike
...
## 2. Task 2: `vm/messages.py` — custom message envelopes
...
## 3. Task 3: `vm/chrome/toast_vm.py` + `vm/chrome/toast_stack_vm.py`
...
## 4. Task 4: `vm/chrome/status_bar_vm.py`
...
## 5. Task 5: `vm/chrome/hint_legend_vm.py`
...
## 6. Task 6: `vm/chrome/command_palette_vm.py`
...
## 7. Task 7: `vm/chrome/confirm_vm.py` + `vm/chrome/quick_look_vm.py`
...
## 8. Task 8: `vm/services_menu_vm.py`
...
## 9. Task 9: `vm/root_vm.py` + integration
...
## 10. Task 10: commit per task + push + tag v0.4.0
...
## 11. Watch-outs (M3-specific) — UPDATED 2026-06-14 after VMx spike
