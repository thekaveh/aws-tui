...
## 1. Task 0: Carry-overs from M0 reviewer
...
## 3. Task 2: `infra/config_store.py`
...
## 5. Task 4: `infra/connection_resolver.py`
...
## 8. Task 7: `infra/keymap_store.py`
...
## 9. Task 8: Final M1 integration sanity test
...
## 10. Task 9: Commit, push, verify CI
