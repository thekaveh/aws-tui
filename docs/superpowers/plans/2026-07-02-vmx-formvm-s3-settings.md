...
### 3.1. Task 1: Pin Facade Behavior And Architecture
...
### 3.2. Task 2: Replace The Internal Primitive
...
### 3.3. Task 3: Remove Obsolete Mini-Primitive
...
### 3.4. Task 4: Record Metrics And Verify
