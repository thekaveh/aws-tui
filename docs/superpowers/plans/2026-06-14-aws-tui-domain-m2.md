...
## 1. Task 1: `domain/filesystem.py` — Protocol + types
...
## 2. Task 2: `domain/local_fs.py` — Local filesystem provider
...
## 3. Task 3: `domain/s3_fs.py` — S3 provider
...
## 4. Task 4: `domain/cross_fs.py` — CrossFsCopy/Move
...
## 5. Task 5: `domain/transfer_journal.py` — Crash-resume journal
...
## 6. Task 6: integration tests with an S3-compatible testcontainer
...
## 7. Task 7: commit, push, tag v0.3.0
